...
from tools import get_nearest_branch, get_suitable_availibility_doctor, get_today_date
...
tools_list = [get_nearest_branch, get_suitable_availibility_doctor, get_today_date]
